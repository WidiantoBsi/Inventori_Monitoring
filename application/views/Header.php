        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if($this->uri->segment(1)=="Devisi"){echo "active";}?>">
                        <a href="<?php echo base_url('Devisi/') ?>">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="password" class="form-control" name="Password" id="nama" maxlength="80" minlength="5" placeholder="Password" required>
                                </div>
                            </div>
                        </div>
